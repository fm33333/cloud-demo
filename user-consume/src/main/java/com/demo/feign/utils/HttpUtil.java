...
//    public static Object get(String url, Class responseType, Map<String, Object> params) {
...
// ----------------------------------通用方法-------------------------------------------------------
    ...
    /*public static void main(String[] args) {
        ...
        params.put("corpid", "ww475076ea132157f1");
        params.put("corpsecret", "jhGMY5CLGhJ_bjJ-hsoK5QOSMPujYtG18I23mEJbOT4");
        System.out.println(HttpUtil.get(url, String.class, params));
    }*/
}
